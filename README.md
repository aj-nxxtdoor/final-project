...
- View all your tasks on the dashboard, filtered and sorted however you like
- Mark tasks as done (or undo if you change your mind)
- Delete tasks you no longer need
- See quick stats about how many tasks you have and how many you've completed
...
If you're using VS Code, the **Live Server** extension makes this easy.
